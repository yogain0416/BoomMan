...
namespace BoomManData
{
    ...
    { 
        ...
        static string sheetID = "2138023545"; // it is sheet id
...
/* Your Loaded Data Storage. */
        ...
        /// <summary>
        /// Get PlayerStatus List 
        /// Auto Load
        /// </summary>
        public static List<PlayerStatus> GetList()
        {{
...
/* Fields. */
		...
		public System.Single boomRange;
		public System.Single boomPower;
		public System.Single boomValue;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            {
#if UGS_DEBUG
                 Debug.Log("PlayerStatus is already loaded! if you want reload then, forceReload parameter set true");
#endif
                 return;
            }
    ...
    public static (List<PlayerStatus> list, Dictionary<string, PlayerStatus> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            ...
            var sheet = jsonObject["PlayerStatus"];
        ...
        public static void Write(PlayerStatus data, System.Action<WriteObjectResult> onWriteCallback = null)
        { 
            TypeMap.Init();
            FieldInfo[] fields = typeof(PlayerStatus).GetFields(BindingFlags.Public | BindingFlags.Instance);
