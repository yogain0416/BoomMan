...
namespace Localization
{
    ...
    { 
        ...
        static string spreadSheetID = "1gih4TWNfqDmeqBMOlsA7pv5NjTEJQPUUV3E6q2AN-XI"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("Localization"); 
            if (text != null)
            {
